...
export const meta = {
  ...
  excerpt:
    "In part two of this series we deployed our new NextJS blog to Vercel and added some styling with TailwindCSS. In this part we are going to add Google Analytics 4 and our own custom Mailchimp signup form.",
  date: "2021-01-27T11:54:05",
