...
export const meta = {
  ...
  excerpt:
    "Setting up a new NextJS project couldn't be easier. Creating a new app is as simple as a single command in your terminal and deploying it with Vercel is the easiest way to have seamless continuous integration for any React app.",
  date: "2021-01-24T11:54:05",
...
export const getPostSlugs = () => {
  return fs
    .readdirSync("./path/to/your/posts")
